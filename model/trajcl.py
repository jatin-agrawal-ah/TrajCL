...
def collate_and_augment(batch, cellspace, embs, aug_func_list):
    ...
    trajs1_cell, trajs1_p, trajs1_timedelta = zip(*[merc2cell2(l,t, cellspace) for l,t in zip( trajs1, time_indices1)])
    trajs2_cell, trajs2_p, trajs2_timedelta = zip(*[merc2cell2(l,t, cellspace) for l,t in zip( trajs2, time_indices2)])
