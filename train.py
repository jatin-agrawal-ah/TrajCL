...
if __name__ == '__main__':
    ...
    trajcl = TrajCLTrainer(Config.trajcl_aug1, Config.trajcl_aug2, Config.trajcl_aug3, Config.trajcl_aug4, Config.trajcl_neg_aug1, Config.trajcl_neg_aug2, Config.trajcl_neg_aug3)
    trajcl.train()
    trajcl.test()
